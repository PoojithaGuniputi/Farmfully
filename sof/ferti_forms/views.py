...
# from ferti_forms.models import FertilizerData
# import pandas as pd
# import csv
# # Create your views here.
# def fertiforms(request):
#     return render(request,"fertilizer.html",{'title': 'Fertilizer'})
...
#         # ferti= FertilizerData(cropname=cropname,nitrogen=N,phosphorous=P,potassium=K)
#         # ferti.save()
...
def addDetails(request):
    ...
    title = 'Fertilizer-Result'
    # if form.is_valid():
    #     cropname = form.cleaned_data['cropname']
    #     N = form.cleaned_data['nitrogen']
    #     P = form.cleaned_data['phosphorous']
    #     K = form.cleaned_data['potassium']
    #     ferti= FertilizerData(crop=cropname,nitrogen=N,phosphorous=P,potassium=K)
    #     ferti.save()
