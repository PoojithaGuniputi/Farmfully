...
function myjsapp(peerClient) {
    ...
    return {
        ...
        createChatWindow: function(id) {
            ...
            var sendBtn = $('<button type="button" class="btn btn-outline-primary btnconnect">Send</button>')
            ...
            $('.panel-body', panel).append('<span class="chat-text">You can now start chatting</span>').append(history)
